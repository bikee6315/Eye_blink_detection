...
EYE_CONSEC_FRAME  — this value is set to 3  to indicate that
...
an eye aspect ratio less than EYE_THRESH  while TOTAL_BLINK is the total number of blinks that have
